...
# ========= GENERATED IMAGES =========
# Gallery thumbnail / video-poster helpers live in their own fork-additive
# module (see docs/fork-additive-policy.md) so this handler keeps a thin seam.
from src.gallery_thumbs import (
    _VIDEO_PLACEHOLDER_SVG,
    _generate_gallery_thumb,
