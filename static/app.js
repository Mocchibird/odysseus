...
import chatModule from './js/chat.js?v=530';
import compareModule from './js/compare/index.js';
import documentModule from './js/document.js?v=530';
import documentWorkspaceModule from './js/documentWorkspace.js?v=530';
...
// notification polling, calendar.js populates the sidebar today-events badge
// + wires its 'calendar-refresh' listener, gallery.js wires its
...
import './js/fork-ui.js?v=458';
// Eagerly bind unified minimize/restore behavior across all tool modals.
import './js/modalManager.js';
// Desktop window tiling — drag a modal near an edge/corner to snap.
import './js/tileManager.js';
import themeModule from './js/theme.js?v=397';
...
// Voice recording is handled by the dual-purpose send/mic button (see below)
  ...
  (function initModelPickerResponsive() {
    ...
    function checkPickerOverflow() {
      ...
      if (textarea) {
        textarea.setAttribute('placeholder', w < PLACEHOLDER_COMPACT_WIDTH ? 'Message...' : 'Message Iris...');
      }
  ...
  async function _handleNewChatAction({ preferModel = true, focus = true } = {}) {
      ...
      // (Deliberately NOT _startFreshChat(), which closes the document panel.)
