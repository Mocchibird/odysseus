...
export const UI_VIS_MAP = {
  ...
  // FORK: extra sidebar sections this fork adds (Planner / Library / AI /
  // Models / Theme). Upstream has no equivalent containers.
...
// FORK: 'models-section' is also off by default here — this fork's sidebar
// ships the Models section collapsed on first run.
