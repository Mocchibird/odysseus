...
function _statusDot(status) {
  const colors = { active: 'var(--color-success, #4caf50)', paused: 'var(--color-blind-orange, #ff9800)', completed: 'var(--color-muted, #888)', error: 'var(--color-error, #f44336)', failed: 'var(--color-error, #f44336)' };
...
function _showTaskDropdown(anchor, items) {
  ...
  const close = bindMenuDismiss(dd, () => dd.remove(), (e) => {
    ...
    // removing the dropdown before the user could see it) by treating them as
    // inside the menu so they don't close it.
    ...
    <div class="admin-card" style="flex:1;display:flex;flex-direction:column;overflow:hidden;position:relative;top:-2px;">
      ...
      <div class="memory-toolbar">
        <div class="memory-category-filters" style="display:flex;align-items:center;gap:6px;">
          ...
          <button class="memory-toolbar-btn" id="tasks-pause-all-btn" title="Pause all active tasks" style="margin-left:auto;position:relative;top:-7px;">Pause all</button>
        </div>
