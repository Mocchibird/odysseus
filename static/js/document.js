...
import { openLibrary, closeLibrary, isLibraryOpen, initLibrary } from './documentLibrary.js?v=532';
...
import { bindMenuDismiss, dismissOrRemove } from './escMenuStack.js';
  ...
  function switchToDoc(docId) {
    ...
    if (prevId && prevId !== docId && docs.has(prevId)) {
      ...
      if (!prev._everHadContent && prev.language !== 'email' && !(prev.content || '').trim() && !(prev.title || '').trim()) {
      ...
      <div class="doc-md-toolbar" id="doc-md-toolbar" style="display:none">
        <div class="md-toolbar-items" id="md-toolbar-items">
          <span class="md-view-toggle" id="doc-md-view-toggle" style="display:none" role="group" aria-label="Edit or preview">
            <button type="button" class="md-view-opt" data-mdview="edit" title="Edit source (⌘/Ctrl+E or Ctrl+Alt+M to toggle)"><span class="md-view-label">Write</span><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.12 2.12 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></button>
            <button type="button" class="md-view-opt" data-mdview="preview" title="Preview (⌘/Ctrl+E or Ctrl+Alt+M to toggle)"><span class="md-view-label">Preview</span><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></button>
            <button type="button" class="md-view-opt" data-mdview="split" title="Split — source + live preview side by side"><span class="md-view-label">Split</span><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="12" y1="3" x2="12" y2="21"/></svg></button>
          </span>
          ...
          <button id="doc-fontsize-btn" class="doc-action-icon-btn" title="Font size" style="position:relative;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="opacity:0.7;"><path d="M4 7V4h16v3"/><path d="M12 4v16"/><path d="M8 20h8"/></svg><span class="doc-fontsize-levels"><i data-sz="s">S</i><i data-sz="m">M</i><i data-sz="l">L</i></span></button>
  ...
  export async function saveDocument({ silent = false, forceVersion = false } = {}) {
    ...
    if (silent && !contentToSave.trim() && localDoc?._everHadContent) {
    ...
    try {
      ...
      _syncDocIndicator();
      _emitDocsChanged('update', savingDocId);
