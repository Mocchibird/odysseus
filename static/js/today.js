  ...
  body.innerHTML = `
    ...
    <section class="today-section">
      <div class="today-section-head">
        ...
        ${overdue.length ? `<button class="memory-toolbar-btn" id="today-carry-forward" style="margin-left:auto;" title="Reschedule ${overdue.length} overdue to today 09:00">Carry ${overdue.length} forward</button>` : ''}
      </div>
  ...
  modal.innerHTML = `
    <div class="modal-content today-modal-content">
      <div class="modal-header">
        ...
        <button class="memory-toolbar-btn" id="today-refresh" title="Refresh"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px;"><path d="M1 4v6h6"/><path d="M23 20v-6h-6"/><path d="M20.49 9A9 9 0 0 0 5.64 5.64L1 10m22 4l-4.64 4.36A9 9 0 0 1 3.51 15"/></svg></button>
