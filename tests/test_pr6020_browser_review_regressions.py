...
"""
    ...
    script = f"""
      ...
      // modalSnap.js reads/writes CSS custom properties on documentElement.style;
      // a bare object has no getPropertyValue/setProperty and throws on load.
      function _styleStub() {{
        const props = new Map();
        return {{
