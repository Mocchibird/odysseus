...
# ── Fork net-new tool implementations ──
# Defined in src/tool_implementations_fork.py and re-exported here so existing
# callers (src/tool_execution.py, src/agent_tools/__init__, tests) keep importing
