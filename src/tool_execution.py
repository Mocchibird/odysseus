...
from src.tool_utils import _truncate, get_mcp_manager  # noqa: F401  (_truncate re-exported; agent_tools import it from here)
...
async def _execute_tool_block_impl(
    ...
    elif tool == "manage_health":
        desc = "manage_health"
        result = await do_manage_health(content, owner=owner)
