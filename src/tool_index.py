...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "manage_health": "Log and query the user's health, habits, and training (same data the Health panel shows). Use for 'log my lunch ~600 kcal', 'I weigh 72kg', 'mark meditation done today', 'calories today', 'weight progress'. Actions: log_meal, log_weight, log_training, check_habit, list_habits, habit_heatmap, calories, weight_trend, summary.",
